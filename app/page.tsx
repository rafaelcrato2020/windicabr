    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-black/50 backdrop-blur-xl">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6">
            <Link href="#markets" className="text-sm font-medium text-white hover:text-yellow-500">
              Mercados
            </Link>
            <Link href="#returns" className="text-sm font-medium text-white hover:text-yellow-500">
              Retornos
            </Link>
            <Link href="#affiliate" className="text-sm font-medium text-white hover:text-yellow-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              className="bg-gradient-to-r from-green-600 to-red-500 hover:from-green-700 hover:to-red-600 text-black font-bold"
              asChild
            >
      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-green-900/40 via-black to-red-900/40" />
        ...
        <div className="container relative z-10">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold tracking-tighter bg-gradient-to-r from-green-500 via-yellow-500 to-red-500 text-transparent bg-clip-text">
            ...
            <div className="relative h-[400px] w-full rounded-lg bg-gradient-to-br from-green-500/20 via-black to-red-500/20 p-1 animate-float overflow-hidden">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-black/10" /> {/* Reduzi a opacidade da sobreposição */}
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-green-500 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-500 to-transparent" />
              <div className="absolute left-0 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-green-500 to-transparent" />
              <div className="absolute right-0 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-red-500 to-transparent" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Markets Section */}
      <section id="markets" className="py-20 bg-gradient-to-b from-black to-green-950">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-green-500 to-red-500 text-transparent bg-clip-text">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <Card
                key={company.name}
                className={`bg-black/50 border-${index % 2 === 0 ? "green" : "red"}-900 overflow-hidden group animate-float`}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <CardContent className="p-6">
                ...
                <p className="text-4xl font-bold text-green-500 mb-4">4%</p>
            ...
            <Card
              className="bg-black/50 border-yellow-900 overflow-hidden animate-float"
            ...
            >
              <CardContent className="p-6">
                ...
                <p className="text-4xl font-bold text-yellow-500 mb-4">7%</p>
                <p className="text-gray-400">
            ...
            <Card
              className="bg-black/50 border-red-900 overflow-hidden animate-float"
            ...
            >
              <CardContent className="p-6">
                ...
                <p className="text-4xl font-bold text-red-500 mb-4">10%</p>
                <p className="text-gray-400">
      ...
      <section id="affiliate" className="py-20 bg-gradient-to-b from-black to-red-950">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-green-500 via-yellow-500 to-red-500 text-transparent bg-clip-text">
              Programa de Afiliados
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-4xl font-bold text-red-500 mb-4">5%</p>
                <p className="text-gray-400">
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <p className="text-4xl font-bold text-red-500 mb-4">2%</p>
      ...
      <section className="py-20 bg-gradient-to-b from-red-950 to-black">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-green-600 to-red-500 hover:from-green-700 hover:to-red-600 text-black font-bold px-8 animate-pulse"
              asChild
            >
              <Link href="/cadastro">
                Cadastre-se no pré-lançamento
